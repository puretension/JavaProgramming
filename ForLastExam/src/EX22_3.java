...
//    private Integer overTimeHours;  // 잔업시간(야근)
//
...
//        
//        //Employ3, Employ4에만 적용(수정) 
//        employees.get(2).setPayManager(new PayLogic2());
//        employees.get(3).setPayManager(new PayLogic2());
//        
