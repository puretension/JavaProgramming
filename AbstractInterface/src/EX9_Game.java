...
//    	int randomAttackIdx = (int) (Math.random() * team.players.size());
//    	attack(team.players.get(randomAttackIdx));
...
//    	for(int i = 0;i<enemy_team.players.size();i++)
//    	{ 
//    		if(minHP >= enemy_team.players.get(i).hp)
//    			{ 
//    			minHP = enemy_team.players.get(i).hp;
//    			minHPIdx = i;
//    			}
//    	}
//    	attack(enemy_team.players.get(minHPIdx));
//    }
//}
//
